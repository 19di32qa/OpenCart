...
import demoOpenCard.PageObjects.Admin.CustomerGroups;
...
public class TC11_DeleteCustomerGroup extends BaseClass {

    @Test
    public void deleteCustomerGroupTest() throws InterruptedException {
        ...
        customerGroups.selectGroup("test group").click();
        customerGroups.getDeleteBtn().click();
